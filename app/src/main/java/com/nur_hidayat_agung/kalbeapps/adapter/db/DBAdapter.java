package com.nur_hidayat_agung.kalbeapps.adapter.db;
...
import com.nur_hidayat_agung.kalbeapps.util.ConstantQuery;
...
public class DBAdapter extends SQLiteAssetHelper {
    ...
    public List<Brand> getBrand()
    {
        ...
        Cursor cursor = db.rawQuery(ConstantQuery.getAllBrand,null);
    ...
    public List<Customer> getCustomer()
    {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(ConstantQuery.getAllCustomer,null);
        if (cursor.getCount() == 1){
            cursor.moveToFirst();
    ...
    public List<Product> getProduct()
    {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(ConstantQuery.getProduct,null);
        if (cursor.getCount() == 1){
            cursor.moveToFirst();
    ...
    public List<Pembelian> getSales()
    {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(ConstantQuery.getSales,null);
        if (cursor.getCount() == 1){
            cursor.moveToFirst();
